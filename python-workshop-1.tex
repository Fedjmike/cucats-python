...
\begin{frame}[fragile]
	...
	\begin{itemize}
		...
		\note<5>{
		When you open the interpreter, you can type things in and press enter to have it read what you wrote.
		
		When you type things in, you should write in Python. The interpreter will complain if you don't.
		
		Things you do in the interpreter aren't permanent. You can always close the window and open it afresh.
