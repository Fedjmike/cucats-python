...
\begin{frame}[fragile]
	...
	\begin{itemize}
		\item Called a list comprehension.
		...
		\note{Keywords are ones that have a special meaning. You cannot use them as variable names. List comprehensions must use `\lstinline|for|' and `\lstinline|in|'}
	\end{itemize}
\end{frame}
