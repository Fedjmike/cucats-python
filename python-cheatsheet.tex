...
\lstdefinelanguage{py}{
	morekeywords={if,elif,else,for,in,def,class,True,False,print,return},
	literate=
		*{=}{{{\color{punct}{=}}}}{1}
		{|}{{{\color{punct}{|}}}}{1}
		{\^}{{{\color{punct}{\^{}}}}}{1}
...
\begin{document}
	...
	\begin{tabular}{l l}
		...
		\, &
		\colorbox{codebg}{\lstinline|["first", "second"]|} \\
		\, &
	...
	Element access (indexing): \colorbox{codebg}{\lstinline|days[1]|}
	
	\colorbox{codebg}{\lstinline|$\colorbox{lightspacebg}{list}$[$\colorbox{lightspacebg}{index}$]|} \\
	
	Comprehensions: \colorbox{codebg}{\lstinline|[x*x for x in nums]|}
