...
\begin{document}
	...
	list.\lstinline|append($\colorbox{spacebg}{item}$)| \\
	list.\lstinline|reverse()| \\
	list.\lstinline|remove($\colorbox{spacebg}{item}$)| \\
	
	string.\lstinline|split($\colorbox{spacebg}{separator}$)| \\
	string.\lstinline|capitalize()| \\
	string.\lstinline|upper()| \\
	string.\lstinline|lower()| \\
	string.\lstinline|find($\colorbox{spacebg}{substring}$)| \\
