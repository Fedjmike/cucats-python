...
\begin{document}
	...
	\colorbox{codebg}{\lstinline|range($\colorbox{lightspacebg}{end}$)|} \\
	\colorbox{codebg}{\lstinline|range($\colorbox{lightspacebg}{start}$,\ $\colorbox{lightspacebg}{end}$)|} \\
	\colorbox{codebg}{\lstinline|range($\colorbox{lightspacebg}{start}$,\ $\colorbox{lightspacebg}{end}$,\ $\colorbox{lightspacebg}{step}$)|} \\
